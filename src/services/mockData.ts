import { Accommodation, Amenity, Review, User } from '../types';
...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'user_admin',
    name: 'Priya Nambiar (Platform Admin)',
    email: 'admin@ecostay.in',
    role: 'admin',
...
export const INITIAL_AMENITIES: Amenity[] = [
  { id: 'solar_power', name: '100% Solar Powered', category: 'sustainability' },
  { id: 'zero_waste', name: 'Zero Waste & Bio-Compost', category: 'sustainability' },
  { id: 'rainwater', name: 'Rainwater Harvesting & Bawadi', category: 'sustainability' },
  { id: 'organic_farm', name: 'Organic Ayurvedic Farm-to-Table', category: 'sustainability' },
  { id: 'ev_charging', name: 'EV Fast Charging Station', category: 'sustainability' },
  { id: 'leed_certified', name: 'GRIHA / IGBC Platinum Certified', category: 'sustainability' },
  { id: 'wifi', name: 'High-speed Fiber/Starlink WiFi', category: 'comfort' },
  { id: 'pool', name: 'Natural Bio-Filtered Spring Pool', category: 'comfort' },
  { id: 'kitchen', name: 'Traditional Clay & Brass Kitchen', category: 'comfort' },
  { id: 'hiking_trails', name: 'Guided Western Ghats Nature Walks', category: 'nature' },
  { id: 'yoga_shala', name: 'Vedic Forest Yoga Shala', category: 'wellness' },
  { id: 'spa', name: 'Herbal Ayurvedic Spa & Panchakarma', category: 'wellness' }
];
...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment: 'Staying 60 feet up in the Wayanad rainforest canopy with full solar power and spring water was mesmerizing. The organic Kerala sadhya prepared from their farm was out of this world.',
    sustainability_comment: 'Verified that all hot water and electricity came from solar panels and rainwater collection.',
    status: 'approved',
  ...
  },
  {
    ...
    accommodation_id: 'eco_2',
    rating: 5,
    comment: 'The Trombe passive solar heating in Leh is a technological marvel! Despite -5°C outside, our room stayed a cozy 22°C without a single drop of diesel.',
    sustainability_comment: 'Zero plastic bottles anywhere on the property; delicious filtered glacier water in copper flasks.',
    status: 'approved',
  ...
  },
  {
    ...
    accommodation_id: 'eco_3',
    rating: 5,
    comment: 'Waking up in the Coorg coffee estate to bird song and zero generator hum was heavenly. The staff explained the entire rainwater harvesting network during the morning walk.',
    sustainability_comment: '100% organic waste composted on-site for the coffee plantation.',
    status: 'approved',
    created_at: '2025-02-24T18:40:00Z'
  }
];
